...
function Brand({ compact = false }: { compact?: boolean }) { return <div className="flex items-center gap-2.5" aria-label="Simbi"><svg className={compact ? "size-7" : "size-8"} viewBox="0 0 44 44" fill="none" aria-hidden="true"><path d="M33 8H18.5C12.7 8 8 11.7 8 16.4s4.7 7.6 10.5 7.6h7C31.3 24 36 27 36 31.6S31.3 39 25.5 39H11" stroke="currentColor" strokeWidth="5" strokeLinecap="round" /></svg><span className={`${compact ? "text-lg" : "text-xl"} font-semibold tracking-[-0.045em]`}>simbi</span></div>; }
